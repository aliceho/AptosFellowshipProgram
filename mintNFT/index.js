...
(async () => {
  ...
  console.log(
    `account1 coins: ${accountResource.data.coin.value}. Should be 100_000_000!`
  );
  ...
  console.log(
    `account2 coins: ${accountResource.data.coin.value}. Should be 0!`
  );
  ...
  accountResource = resources.find((r) => r.type === aptosCoin);
  console.log(
    `account2 coins: ${accountResource.data.coin.value}. Should be 717!`
  );
